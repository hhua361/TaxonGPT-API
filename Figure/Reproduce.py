...
# 设置轴标签和标题
ax.set_xlabel('Reproducibility Score', fontsize=20, family='Arial')
ax.set_ylabel('Method', fontsize=20, family='Arial')
ax.set_title('Reproducibility Scores for API and Web Methods', fontsize=22, family='Arial')
...
ax.legend(handles, labels, title='Dataset/Time', bbox_to_anchor=(1.05, 1), loc='upper left', fontsize=14, title_fontsize=16, prop={'family': 'Arial'})
...
# 保存为SVG格式
output_path = 'E:/Evaluate_results_for_all_datasets/Evaluate_table/Reproducibility/Reproducibility.svg'
